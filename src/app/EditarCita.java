...
public class EditarCita extends javax.swing.JFrame {
    ...
    public EditarCita(GestorMain gestor, Cita cita, int idCita) {
        ...
        cmbMascotas.setSelectedItem(cita.getNombreMascota());
        cmbVeterinarios.setSelectedItem(cita.getVeterinario());
        cmbDia.setSelectedItem(cita.getDia());
        cmbHoras.setSelectedItem(cita.getHora());
        txtAreaMotivo.setText(cita.getMotivo());
    }
    ...
    private void initComponents() {
        ...
        lblAgendarHora.setText("Actualizar Cita");
        ...
        lblRegistrar.setText("ACTUALIZAR");
        ...
        panelVolverMenuLayout.setHorizontalGroup(
            ...
            .addComponent(lblVolverMenu, javax.swing.GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE)
        );
    ...
    private void lblRegistrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblRegistrarMouseClicked
        ...
        gestor.modificarCita(idCita, cita);
